public class Main {
    ...
    private static void task4() {
        ...
        while (deposit <= total) {
            ...
            counter++;
            System.out.println("Месяц " + counter + " сумма накоплений равна " + deposit);
    ...
    private static void task7() {
        ...
        while (currenDay <= days) {
            System.out.println("Сегодня пятница, " + currenDay + "-е число. Необходимо подготовить отчет");
            currenDay +=7;
        ...
        int next = 100;
        int nowYear = 2023;
         int start = nowYear - previous;
         int finish = nowYear + next;
